---
title: ACWING周赛-35
date: 2022-01-22 22:10:43.084
updated: 2022-01-22 22:10:43.084
url: /archives/acwing-zhou-sai--35
categories: 算法
tags: 
---
...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 1; i < n - 1; i++) {
            ...
            if(minl != (int) 3e9 && minr !=(int) 3e9){
                ans = min(minl + c[i] + minr, ans);
            }

        }
        System.out.println(ans == (int)3e9?-1:ans);
        ;
    }
}
